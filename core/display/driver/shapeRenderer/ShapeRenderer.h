...
namespace pico_ssd1306{
    ...
    /// \brief Draws a circle with center at x_center, y_center and radius
    /// \param x_center, y_center - center of the circle
    /// \param radius - radius of the circle
    /// \param mode - mode describes setting behavior. See WriteMode doc for more information
    void drawCircle (pico_ssd1306::SSD1306 *ssd1306, uint8_t x_center, uint8_t y_center, uint8_t radius, pico_ssd1306::WriteMode mode = pico_ssd1306::WriteMode::ADD);

    /// \brief Fills a circle with center at x_center, y_center and radius
    /// \param x_center, y_center - center of the circle
    /// \param radius - radius of the circle
    /// \param mode - mode describes setting behavior. See WriteMode doc for more information
    void fillCircle (pico_ssd1306::SSD1306 *ssd1306, uint8_t x_center, uint8_t y_center, uint8_t radius, pico_ssd1306::WriteMode mode = pico_ssd1306::WriteMode::ADD);
}
